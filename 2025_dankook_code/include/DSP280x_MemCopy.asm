...
;* Date/Time created: Sat Aug 23 16:58:42 2025                 *
;***************************************************************
...
;	C:\line_tracer\asd_3\Compiler\bin\opt2000.exe C:\Users\balam\AppData\Local\Temp\TI26810 C:\Users\balam\AppData\Local\Temp\TI2684 
;	C:\line_tracer\asd_3\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -IC:\line_tracer\asd_3\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\balam\AppData\Local\Temp\TI2682 --template_info_file C:\Users\balam\AppData\Local\Temp\TI2686 --object_file DSP280x_MemCopy.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments 
	.sect	".text"
	.global	_MemCopy
...
DW$9	.dwtag  DW_TAG_loop
	.dwattr DW$9, DW_AT_name("C:\line_tracer\asd_3\main\DSP280x_MemCopy.asm:L1:1:1755935922")
