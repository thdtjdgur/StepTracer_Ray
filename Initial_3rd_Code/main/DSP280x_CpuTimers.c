...
void Init_ISR(void)
{
	...
	PieVectTable.ADCINT = &ADC_TIMER_ISR; // ADC, motor interrupt


	EDIS;    // This is needed to disable write to EALLOW protected registers

	IER |= ( M_INT1 | M_INT14 );//TINT0, TINT1 Enable...........................( CPU 인터럽트 TINT0, INT1 활성화)

	PieCtrlRegs.PIEIER1.bit.INTx7 = 1; //Sensor interrupt.........................../* PIE 인터럽트 (TINT0) 활성화 */
	PieCtrlRegs.PIEIER1.bit.INTx6 = 1; //ADC interrupt	.........................../* PIE 인터럽트 (ADCINT) 활성화 */

	ConfigCpuTimer( &CpuTimer0 , 100.0 , 25 ); // sensor interrupt 25us
	ConfigCpuTimer( &CpuTimer2 , 100.0 , 149 ); // motor interrupt 500us//100
