...
void Race_Init()
{
    ...
    //read_handle_dec_rom();
   	...
   	//g_q17_handle_acc = _IQmpyIQX(_IQ17(g_i16_handle_acc), 17, _IQ27(0.0000001), 27); //내가 지움 
	//g_q15_handle_dec = _IQ15mpyIQX(_IQ15(g_i16_handle_dec), 15, _IQ27(0.000001), 27); //내가 지움 
}
